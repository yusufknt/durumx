        ...
        <ModalContext.Provider value={{ orderOpen, setOrderOpen }}>
          ...
          {orderOpen && (
            ...
            >
              ...
              <div
                className="relative bg-gradient-to-br from-white/95 via-gray-50/95 to-white/95 backdrop-blur-xl rounded-3xl w-full max-w-4xl shadow-2xl border border-gray-200/50 overflow-hidden animate-modal-slide-in"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Close Button */}
                <button
                  className="absolute top-6 right-6 p-3 rounded-full bg-white/90 backdrop-blur-sm hover:bg-red-50 transition-all duration-300 group z-50 shadow-lg hover:shadow-xl hover:scale-110 border border-gray-200/50"
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                <div className="relative z-10 text-center py-8 px-8">
                  <div className="flex justify-center mb-4">
                    <div className="relative">
                      <div className="bg-gradient-to-br from-red-50 to-orange-50 backdrop-blur-sm rounded-full p-3 shadow-lg border border-red-200/50">
                        <Image
                          src="/logo.png"
                          alt="DürümX Logo"
                          width={56}
                  ...
                  <h2 className="text-4xl font-black bg-gradient-to-r from-red-600 via-orange-500 to-red-700 bg-clip-text text-transparent mb-2">
                    Sipariş Ver
                  </h2>
                ...
                {/* Footer */}
                <div className="relative z-10 text-center py-6 border-t border-gray-200/50 bg-gradient-to-r from-gray-50/50 via-white/50 to-gray-50/50">
