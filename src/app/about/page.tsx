...
const AboutPage = () => (
  <section className="w-full min-h-[80vh] bg-gradient-to-br from-[#fff0e6] via-[#ffe5ec] to-[#f7f7fa] py-16 px-4 flex items-center justify-center">
    <div className="max-w-5xl w-full mx-auto bg-white/70 backdrop-blur-md rounded-3xl shadow-2xl border border-[#ececec] flex flex-col md:flex-row items-center md:items-stretch gap-10 p-8 md:p-14">
      {/* Sol: Görsel */}
      <div className="flex-1 flex items-center justify-center">
        <img src="/about-placeholder.jpg" alt="DürümX Hakkımızda" className="w-64 h-64 object-cover rounded-3xl shadow-xl border-4 border-[#e63946]" />
      </div>
      {/* Sağ: İçerik */}
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="mt-2 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {NEDENLER.map((n) => (
              <div key={n.title} className="flex items-center gap-3 bg-white/90 rounded-xl p-3 shadow border border-[#ececec]">
                {n.icon}
                <div>
